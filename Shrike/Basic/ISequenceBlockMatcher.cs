...
namespace Nanoray.Shrike
{
        ...
        where TBlockMatcher : ISequenceBlockMatcher<TElement, TPointerMatcher, TBlockMatcher>
    {
        ...
        TBlockMatcher EmptyBlockMatcherBeforeStart
            => this.MakeBlockMatcher(this.Length == 0 ? this.StartIndex : this.StartIndex - 1, 0);

        TBlockMatcher EmptyBlockMatcherAfterEnd
            => this.MakeBlockMatcher(this.EndIndex, 0);
    ...
    {
        public static TBlockMatcher Find<TElement, TPointerMatcher, TBlockMatcher>(this TBlockMatcher self, params IElementMatch<TElement>[] toFind)
            where TPointerMatcher : ISequencePointerMatcher<TElement, TPointerMatcher, TBlockMatcher>
            where TBlockMatcher : ISequenceBlockMatcher<TElement, TPointerMatcher, TBlockMatcher>
            => self.Find(toFind);

        public static TBlockMatcher Find<TElement, TPointerMatcher, TBlockMatcher>(this TBlockMatcher self, SequenceBlockMatcherFindOccurence occurence, SequenceBlockMatcherFindBounds bounds, params IElementMatch<TElement>[] toFind)
            where TPointerMatcher : ISequencePointerMatcher<TElement, TPointerMatcher, TBlockMatcher>
            where TBlockMatcher : ISequenceBlockMatcher<TElement, TPointerMatcher, TBlockMatcher>
            => self.Find(occurence, bounds, toFind);

        public static TBlockMatcher EncompassUntil<TElement, TPointerMatcher, TBlockMatcher>(this TBlockMatcher self, SequenceMatcherPastBoundsDirection direction, params IElementMatch<TElement>[] toFind)
            where TPointerMatcher : ISequencePointerMatcher<TElement, TPointerMatcher, TBlockMatcher>
            where TBlockMatcher : ISequenceBlockMatcher<TElement, TPointerMatcher, TBlockMatcher>
            => self.EncompassUntil(direction, toFind);

        public static TBlockMatcher Insert<TElement, TPointerMatcher, TBlockMatcher>(this TBlockMatcher self, SequenceMatcherPastBoundsDirection position, bool includeInsertionInResultingBounds, params TElement[] elements)
            where TPointerMatcher : ISequencePointerMatcher<TElement, TPointerMatcher, TBlockMatcher>
            where TBlockMatcher : ISequenceBlockMatcher<TElement, TPointerMatcher, TBlockMatcher>
